...
export default function DataSourcesPage() {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      case 'connected':
        return <CheckCircle className="w-5 h-5 text-[#06B6D4]" />;
      case 'error':
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-[#64748B] text-[14px]">Loading data sources...</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="p-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-[24px] font-bold text-[#F8FAFC] mb-2">Data Sources</h1>
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-3 bg-gradient-to-br from-[#6366F1] to-[#4F46E5] text-white text-[14px] font-medium rounded-xl hover:opacity-90 transition-all shadow-lg shadow-indigo-500/20"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-gradient-to-br from-[#06B6D4]/20 to-[#06B6D4]/5 border border-[#06B6D4]/30 rounded-xl p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[24px] font-bold text-[#0F172A]">{connectedSources}</p>
                <p className="text-[13px] text-[#64748B]">Connected</p>
              </div>
            </div>
          </div>
          <div className="bg-gradient-to-br from-[#6366F1]/20 to-[#6366F1]/5 border border-[#6366F1]/30 rounded-xl p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[13px] text-[#64748B]">Total Sessions</p>
              </div>
            </div>
          </div>
          <div className="bg-gradient-to-br from-[#f59e0b]/20 to-[#f59e0b]/5 border border-[#f59e0b]/30 rounded-xl p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[24px] font-bold text-[#0F172A]">Live</p>
                <p className="text-[13px] text-[#64748B]">Data Status</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-[18px] font-semibold text-[#F8FAFC]">{source.name}</h3>
                    ...
                    <div className="flex gap-6">
                      {source.metrics.sessions !== undefined && (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[13px] text-[#94A3B8]">
                            <span className="text-[#F8FAFC] font-medium">{source.metrics.sessions.toLocaleString()}</span> sessions
                          </span>
                        </div>
                      )}
                      {source.metrics.users !== undefined && (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[13px] text-[#94A3B8]">
                            <span className="text-[#F8FAFC] font-medium">{source.metrics.users.toLocaleString()}</span> users
                          </span>
                        </div>
                      )}
                      {source.metrics.records !== undefined && !source.metrics.sessions && (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[13px] text-[#94A3B8]">
                            <span className="text-[#F8FAFC] font-medium">{source.metrics.records.toLocaleString()}</span> records
                          </span>
                        </div>
                      )}
                      {source.status === 'disconnected' && (
                        <span className="text-[13px] text-[#64748B]">Not configured</span>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  {source.status === 'connected' ? (
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2.5 bg-white/60 text-[#0F172A] border border-[#6366F1]/30 text-[13px] font-medium rounded-lg hover:bg-white/80 transition-all disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2.5 bg-[#6366F1]/20 text-[#818CF8] text-[13px] font-medium rounded-lg hover:bg-[#6366F1]/30 transition-all"
                    >
                      <Link2 className="w-4 h-4" />
                      Connect
                    </button>
                  ...
                  <button
                    ...
                    className="p-2.5 bg-[#111827] text-[#94A3B8] rounded-lg hover:bg-[#0F172A] hover:text-[#F8FAFC] transition-all"
                  >
        ...
        <div className="mt-8">
          <h2 className="text-[18px] font-semibold text-[#F8FAFC] mb-4">Available Integrations</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div
                ...
                className="bg-gradient-to-br from-[#6366F1]/20 to-[#6366F1]/5 border border-dashed border-[#6366F1]/30 rounded-xl p-5 hover:border-[#6366F1]/50 transition-all cursor-pointer group"
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-white/60 rounded-xl flex items-center justify-center text-[24px] border border-[#6366F1]/20">
                    {integration.icon}
                  </div>
                  <div className="flex-1">
                    <p className="text-[14px] font-medium text-[#F8FAFC] group-hover:text-[#6366F1] transition-colors">
                      {integration.name}
                    </p>
                    <p className="text-[12px] text-[#64748B]">{integration.description}</p>
                  </div>
                  <Link2 className="w-5 h-5 text-[#555555] group-hover:text-[#6366F1] transition-colors" />
                </div>
              </div>
            ))}
          </div>
        ...
        {/* AI Integration Info */}
        <div className="mt-8 bg-gradient-to-br from-[#6366F1]/10 to-transparent border border-[#6366F1]/20 rounded-2xl p-6">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 bg-[#6366F1]/20 rounded-xl flex items-center justify-center">
              <Brain className="w-6 h-6 text-[#6366F1]" />
            </div>
            <div>
              <h3 className="text-[16px] font-semibold text-[#F8FAFC] mb-2">AI-Powered Analysis</h3>
              ...
              <div className="flex gap-3">
                <Link
                  href="/explore-ai"
                  className="px-4 py-2 bg-[#6366F1]/20 text-[#818CF8] text-[13px] font-medium rounded-lg hover:bg-[#6366F1]/30 transition-all"
                >
                  Explore AI Insights
                </Link>
              </div>
        ...
        {showConnectModal && (
          <div className="fixed inset-0 bg-white/80 flex items-center justify-center z-50 p-6">
            <div className="bg-white border border-[#CBD5E1] rounded-2xl p-8 max-w-2xl w-full">
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h2 className="text-[20px] font-semibold text-[#F8FAFC] mb-2">
              ...
              {showConnectModal === 'clarity' && (
                <div className="space-y-5">
                  <div className="bg-white/60 border border-[#6366F1]/20 rounded-xl p-5">
                    <div className="flex items-start gap-3 mb-4">
                      <AlertCircle className="w-5 h-5 text-[#6366F1] flex-shrink-0 mt-0.5" />
                      <div>
                        <h3 className="text-[15px] font-semibold text-[#F8FAFC] mb-1">Get your API Key</h3>
                        <p className="text-[13px] text-[#94A3B8]">
                          Go to <a href="https://clarity.microsoft.com" target="_blank" rel="noopener noreferrer" className="text-[#6366F1] hover:underline">Microsoft Clarity</a> →
                    ...
                    <div className="space-y-3">
                      <label className="block">
                        <span className="text-[14px] font-medium text-[#F8FAFC] mb-2 block">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-white border border-[#CBD5E1] rounded-lg text-[#F8FAFC] text-[14px] placeholder:text-[#64748B] focus:outline-none focus:border-[#6366F1] transition-all font-mono"
                          autoFocus
                        />
                      </label>
                  ...
                  {apiKeys.clarity && (
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="text-[13px] text-[#EF4444] hover:text-[#ff5252] transition-colors"
                      >
                        Disconnect
                      </button>
                    </div>
              ...
              {(showConnectModal === 'crazy_egg' || showConnectModal === 'google_analytics') && (
                <div className="bg-[#111827] border border-[#CBD5E1] rounded-xl p-6 text-center">
                  <p className="text-[14px] text-[#94A3B8] mb-4">
              ...
              <div className="mt-6 flex justify-end gap-3">
                <button
                  ...
                  className="px-6 py-2.5 bg-white/60 text-[#64748B] border border-[#6366F1]/30 text-[14px] font-medium rounded-lg hover:bg-white/80 hover:text-[#0F172A] transition-all"
                >
                  Cancel
                </button>
                {showConnectModal === 'clarity' && (
                  <button
                    ...
                    className="px-6 py-2.5 bg-[#6366F1] text-white text-[14px] font-medium rounded-lg hover:bg-[#4F46E5] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
