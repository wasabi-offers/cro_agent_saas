    ...
    <div className="mb-10">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-[18px] font-semibold text-[#F8FAFC]">Quick Wins</h3>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {quickWins.map((win, index) => {
          ...
          return (
            <div
              key={win.id}
              className="bg-[#0B0F19] border border-[#1E293B] rounded-xl p-6 hover:border-[#6366F1]/50 transition-all group"
            >
              {/* Header */}
              ...
              {/* Content */}
              <h4 className="text-[15px] font-semibold text-[#F8FAFC] mb-2">
                {win.title}
              </h4>
              <p className="text-[13px] text-[#94A3B8] mb-4 line-clamp-2">
                {win.description}
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="bg-[#111827] rounded-lg p-3">
                  <div className="flex items-center gap-1.5 mb-1">
                    ...
                    <span className="text-[11px] text-[#94A3B8]">Effort</span>
                  </div>
                  <span className="text-[13px] font-semibold text-[#F8FAFC]">{win.effort}</span>
                </div>
                <div className="bg-[#111827] rounded-lg p-3">
                  <div className="flex items-center gap-1.5 mb-1">
                    <TrendingUp className="w-3.5 h-3.5 text-[#06B6D4]" />
                    <span className="text-[11px] text-[#94A3B8]">Expected</span>
                  </div>
                  <span className="text-[13px] font-semibold text-[#06B6D4]">{win.expectedIncrease}</span>
                </div>
              </div>

              {/* Action */}
              <button className="w-full bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] text-white px-4 py-2.5 rounded-lg text-[13px] font-medium hover:shadow-lg hover:shadow-indigo-500/20 transition-all flex items-center justify-center gap-2 group-hover:gap-3">
              ...
              <div className="mt-3 text-center">
                <span className="text-[11px] text-[#64748B]">
                  Page: <span className="text-[#94A3B8]">{win.page}</span>
                </span>
              </div>
            </div>
          );
