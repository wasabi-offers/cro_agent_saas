...
export default function StepCROPreviewModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-[#0a0a0a] border border-[#2a2a2a] rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
        <div className="p-6 border-b border-[#2a2a2a] flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            <Eye className="w-6 h-6 text-[#7c5cff]" />
            <h2 className="text-[18px] font-semibold text-[#fafafa]">CRO Preview - {stepName}</h2>
          </div>
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="p-6">
            <h4 className="text-[14px] font-semibold text-[#fafafa] mb-3 flex items-center gap-2">
