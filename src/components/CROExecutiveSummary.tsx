...
export default function CROExecutiveSummary({ results, source }: CROExecutiveSummaryProps) {
  ...
  const scoreColor = avgScore >= 80 ? "text-[#3b82f6]" : avgScore >= 60 ? "text-[#f59e0b]" : "text-[#ff6b6b]";
  const scoreBg = avgScore >= 80 ? "bg-[#3b82f6]/10 border-[#3b82f6]/20" : avgScore >= 60 ? "bg-[#f59e0b]/10 border-[#f59e0b]/20" : "bg-[#ff6b6b]/10 border-[#ff6b6b]/20";
    ...
    <div className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-2xl p-6 mb-6">
      ...
      {topQuickWins.length > 0 && (
        <div className="mt-4 pt-4 border-t border-[#2a2a2a]">
          <div className="flex items-center gap-2 text-[12px] font-semibold text-[#3b82f6] mb-2">
